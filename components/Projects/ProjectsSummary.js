const ProjectsSummary = () => {
    return (
        <div className="grid grid-cols-1 px-6 py-20 space-y-10 bg-white lg:px-auto md:px-10 lg:mx-auto lg:container md:py-28 sm:grid-cols-2 ">
            <div className="space-y-8">
                <h3 className="text-base font-medium text-brandGreen-light">Available Properties</h3>
